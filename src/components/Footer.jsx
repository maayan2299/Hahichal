            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex gap-3 mt-2">
                <a href={WHATSAPP} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full bg-[#25D366] hover:opacity-80 flex items-center justify-center transition-colors">
                ...
                <a href={INSTAGRAM} target="_blank" rel="noopener noreferrer"
                  className="w-9 h-9 rounded-full bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 hover:opacity-80 flex items-center justify-center transition-colors">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
