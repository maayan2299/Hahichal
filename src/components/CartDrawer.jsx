        ...
        <div className="flex-1 overflow-y-auto p-6">
          {cart.length === 0 ? (
            <div className="text-center py-12">
              ...
              <button onClick={() => setIsCartOpen(false)} className="px-6 py-3 bg-black text-white hover:bg-gray-800 transition-colors">
                המשך בקניות
              </button>
            </div>
          ) : (
        ...
        {cart.length > 0 && (
          <div className="border-t border-gray-200 p-6 bg-gray-50">
            ...
            <Link
              to="/cart"
              onClick={() => setIsCartOpen(false)}
              className="block w-full bg-black text-white text-center py-4 font-medium hover:bg-[#D4AF37] transition-colors mb-2"
            >
              מעבר לתשלום
            </Link>
            <button
