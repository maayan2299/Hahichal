  ...
  return (
    <div className="space-y-8 text-gray-800 leading-relaxed">
      <section>
        ...
        <p className="mb-4">
          ברוכים הבאים לאתר "ההיכל" לתשמישי קדושה. אנו מתחייבים להגן על פרטיותכם ולשמור על המידע האישי שלכם בצורה אחראית ובטוחה.
        </p>
      ...
      <section>
        ...
        <ul className="list-none space-y-2 mt-3">
          <li>📧 דוא"ל: info@ההיכל.com</li>
          <li>📞 טלפון: 054-211-5584</li>
        </ul>
      </section>
    </div>
  )
  ...
  return (
    <div className="space-y-8 text-gray-800 leading-relaxed">
      <section>
        ...
        <p className="mb-4">
          תקנון זה מסדיר את תנאי השימוש באתר "ההיכל" ואת היחסים בין החנות ללקוחותיה. השימוש באתר מהווה הסכמה לתנאים אלו.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          כל התכנים באתר, לרבות טקסטים, תמונות ולוגו, הם רכושה הבלעדי של "ההיכל" ומוגנים בזכויות יוצרים. אין להעתיק, לשכפל או להפיץ ללא אישור בכתב.
        </p>
      </section>
